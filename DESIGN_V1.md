...
```text
CRF 36.0 · preset medium · GOP 2-10s · ref 4 · b-frames 4 · lookahead 45 · 无roi · 无降噪
```
...
| H.265 固定参数方案 | `libx265` | `medium` | 36.0 | ref=4 / bframes=4 / lookahead=45 / GOP=10秒 / min=2秒 | 无 ROI、无降噪 |
